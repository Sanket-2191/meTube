...
import { sideBarVisSelector, toggleVisibility } from '../store/sideBarSlice.js';
...
const VideoListing = () => {
    ...
    return (
        ...
        <section className="w-full  sm:ml-[70px] sm:pb-0 lg:ml-0" onClick={() => visible ? dispatch(toggleVisibility()) : null}>
